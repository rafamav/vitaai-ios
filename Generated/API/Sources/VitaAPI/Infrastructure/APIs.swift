...
open class VitaAPIAPIConfiguration: @unchecked Sendable {
    ...
    public init(
        basePath: String = "https://app.vita-ai.cloud",
    ...
    public static let shared = VitaAPIAPIConfiguration()
}
...
open class RequestBuilder<T: Sendable>: @unchecked Sendable, Identifiable {
    ...
    public let apiConfiguration: VitaAPIAPIConfiguration

    /// Optional block to obtain a reference to the request's progress instance when available.
    public var onProgressReady: ((Progress) -> Void)?

    required public init(method: String, URLString: String, parameters: [String: any Sendable]?, headers: [String: String] = [:], requiresAuthentication: Bool, apiConfiguration: VitaAPIAPIConfiguration = VitaAPIAPIConfiguration.shared) {
        self.method = method

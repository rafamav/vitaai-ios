...
enum VitaTokens {
    ...
    // MARK: Dark Colors
    enum DarkColors {
        static let bg = Color(red: 0.102, green: 0.078, blue: 0.071)
        static let bgCard = Color(red: 0.118, green: 0.094, blue: 0.086)
        static let bgElevated = Color(red: 0.086, green: 0.071, blue: 0.063)
        static let bgHover = Color(red: 0.145, green: 0.125, blue: 0.094)
        static let bgActive = Color(red: 0.165, green: 0.145, blue: 0.125)
        static let bgSubtle = Color(red: 0.188, green: 0.149, blue: 0.118)
        static let borderSurface = Color(red: 0.165, green: 0.141, blue: 0.125)
        static let text = Color(red: 1.000, green: 1.000, blue: 1.000).opacity(0.7)
        static let textSecondary = Color(red: 1.000, green: 1.000, blue: 1.000).opacity(0.25)
        static let textMuted = Color(red: 1.000, green: 1.000, blue: 1.000).opacity(0.15)
        ...
        static let accent = Color(red: 0.784, green: 0.627, blue: 0.314)
        static let accentHover = Color(red: 0.690, green: 0.541, blue: 0.251)
    ...
    enum LightColors {
        ...
        static let accent = Color(red: 0.690, green: 0.541, blue: 0.251)
        static let accentHover = Color(red: 0.596, green: 0.459, blue: 0.188)
        static let accentSubtle = Color(red: 0.690, green: 0.541, blue: 0.251).opacity(0.06)
    }

    // MARK: Primitive Colors
    enum PrimitiveColors {
        static let gold300 = Color(red: 0.831, green: 0.722, blue: 0.439)
        static let gold400 = Color(red: 0.784, green: 0.627, blue: 0.314)
        static let gold500 = Color(red: 0.690, green: 0.541, blue: 0.251)
        static let gold600 = Color(red: 0.596, green: 0.459, blue: 0.188)
        static let gold700 = Color(red: 0.502, green: 0.376, blue: 0.125)
    ...
    enum Components {
        ...
        enum GlassCard {
            static let radius: CGFloat = 14
            static let bgAlpha: Double = 0.05
            static let borderAlpha: Double = 0.07
            static let blur: CGFloat = 20
            static let saturate: CGFloat = 1.4
            static let insetHighlight = "rgba(255, 255, 255, 0.06)"
        }
        enum ChatBubble {
